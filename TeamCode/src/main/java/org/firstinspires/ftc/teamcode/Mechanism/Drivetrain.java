...
public class Drivetrain {
    ...
    public Drivetrain(@NonNull HardwareMap hardwareMap) {
        ...
        odo = new Odometry(hardwareMap, 133.35f, 152.4f);
        this.resetOdo();
    }
    ...
    public void robotOrientedDrive(double forward, double sideways, double rotation) {
        ...
        backRight.setPower((forward  + sideways - rotation)/1.6);
    }

    public void LQRDrive(double fl, double fr, double bl, double br){
    ...
    public double[] getVelocity() {
        ...
        return new double[] {
                ...
                odo.getPinpoint().getVelocity().getHeading(AngleUnit.DEGREES)
        };
    }
    public double[] getPositionRaw() {
        return odo.getPosition();  // no updateOdo() call — just returns last-read values
    }
    ...
    public String toString() {
        return  "Slow: " + isSlow() + "\n" +
                ...
                odo.toString()  + "\n" +
                "Raw odo: " + Arrays.toString(getPositionRaw()) +
